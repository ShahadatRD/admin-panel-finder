...
#   Function      :   BruteForce Admin Login Page

#   Platform     :   Python

#   Coder          :   R3t1r3d D3v1l

#   Page           :   www.facebook.com/r3t1r3d.d3v1l
...
#                   then install it and put this script on desktop
...
#                 no downloads required because python 2.7 is allready installed 

#                1)    put the script on Desktop

#                2)   open the Terminal and type those commands to run it
...
print color.GREEN + color.BOLD + "\n[+] ============|| Blacksmith Hackers Team ||============ [+]" + color.END
...
print color.GREEN + color.BOLD + "[+] ===============|| Admin Page Finder ||=============== [+]" + color.END
...
print color.GREEN + color.BOLD + "[+] =====|| Follow Us For More ||======= [+]" + color.END
...
print color.GREEN + color.BOLD + "[+] =========|| Coded By R3t1r3d D3v1l ||=========== [+] " + color.END
...
print color.GREEN + color.BOLD + "[+] =======|| fb :  fb.com/r3t1r3d.d3v1l ||======== [+] "
...
website = raw_input("[+] Enter website Link : http://")
...
try:
     ...
     for link in path:
      ...
      R3t1r3dD3v1l = httplib.HTTPConnection(website)





      R3t1r3dD3v1l.request('GET', link)
      ...
      R3t1r3dD3v1l = R3t1r3dD3v1l.getresponse()
      ...
      print'%s %s %s' % (link,R3t1r3dD3v1l.status,R3t1r3dD3v1l.reason)
      ...
      if R3t1r3dD3v1l.status == 200:
       ...
       print color.GREEN + " [+] Page Found <(200 OK )> " + color.END
       ...
       print color.GREEN + " [+] This path may redirect you to admin page > Check It " + color.END
      ...
      print ("[@] JOB FINISHED || visit : http://www.facebook.com/r3t1r3d.d3v1l ")
